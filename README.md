...
Another classic recursion problem is the Tower of Hanoi problem where we need to move all disks from A to C, by moving one disk at a time, where a disk may never be on top of a smaller disk.
